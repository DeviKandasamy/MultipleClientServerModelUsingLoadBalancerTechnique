...
public class Client3 {
	...
	Client3() throws IOException {
		...
		File file = new File("C:/Users/Devi/Documents/scu/COEN233/project/Project/Demo/March9/AmbikaPreethi/src/ClientServer/test3.txt");
		...
		try
		{
           ...
           System.out.println(Client3.getCurrentTime() + "::" +"Patient ID: " +PatientId);
